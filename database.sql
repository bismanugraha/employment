...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dayoff` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'day off id',
  `eid` bigint NOT NULL COMMENT 'employee id',
  `startdate` date NOT NULL,
  `enddate` date NOT NULL,
  `reason` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `dayoff_employee_FK` (`eid`),
  CONSTRAINT `dayoff_employee_FK` FOREIGN KEY (`eid`) REFERENCES `employee` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-04-18 12:20:43
